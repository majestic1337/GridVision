...
ENV_IMAGE_MODEL = "GV_IMAGE_MODEL"
ENV_IMAGE_EMBEDDINGS = "GV_IMAGE_EMBEDDINGS"
ENV_IMAGE_MIN_SCORE = "GV_IMAGE_MIN_SCORE"

DEFAULT_IMAGE_TOP_K = 8
DEFAULT_IMAGE_MIN_SCORE = 0.0
